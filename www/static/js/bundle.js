...
`))?true:__oak_eq(__oak_cond,__Oak_String(``))?true:__oak_eq(__oak_cond,__Oak_String(``))?true:false)(c)}),letter__oak_qm=function letter__oak_qm(c=null){return __oak_or(upper__oak_qm(c),lower__oak_qm(c))},word__oak_qm=function word__oak_qm(c=null){return __oak_or(letter__oak_qm(c),digit__oak_qm(c))},join=function join(strings=null,joiner=null){return ((joiner=__oak_js_default(joiner,__Oak_String(``))),((__oak_cond)=>__oak_eq(__oak_cond,0)?__Oak_String(``):reduce(slice(strings,1),__oak_acc(strings,0),function _(a=null,b=null){return __as_oak_string(__as_oak_string(a+joiner)+b)}))(len(strings)))},startsWith__oak_qm=function startsWith__oak_qm(s=null,prefix=null){return reduce(prefix,true,function _(acc=null,c=null,i=null){return (__oak_and(acc,(__oak_eq(__oak_acc(s,__oak_obj_key((i))),c))))})},endsWith__oak_qm=function endsWith__oak_qm(s=null,suffix=null){return ((diff)=>((diff=(len(s)-len(suffix))),reduce(suffix,true,function _(acc=null,c=null,i=null){return (__oak_and(acc,(__oak_eq(__oak_acc(s,__oak_obj_key((__as_oak_string(i+diff)))),c))))})))()},_matchesAt__oak_qm=function _matchesAt__oak_qm(s=null,substr=null,idx=null){return ((__oak_cond)=>__oak_eq(__oak_cond,0)?true:__oak_eq(__oak_cond,1)?__oak_eq(__oak_acc(s,__oak_obj_key((idx))),substr):((max,sub)=>((max=len(substr)),sub=function sub(i=null){return ((__oak_trampolined_sub)=>((__oak_trampolined_sub=function _(i=null){return ((__oak_cond)=>__oak_eq(__oak_cond,max)?true:((__oak_cond)=>__oak_eq(__oak_cond,__oak_acc(substr,__oak_obj_key((i))))?__oak_trampoline(__oak_trampolined_sub,__as_oak_string(i+1)):false)(__oak_acc(s,__oak_obj_key((__as_oak_string(idx+i))))))(i)}),__oak_resolve_trampoline(__oak_trampolined_sub,i)))()},sub(0)))())(len(substr))},indexOf=function indexOf(s=null,substr=null){return ((max,sub)=>((max=(len(s)-len(substr))),sub=function sub(i=null){return ((__oak_trampolined_sub)=>((__oak_trampolined_sub=function _(i=null){return ((__oak_cond)=>__oak_eq(__oak_cond,true)?i:((__oak_cond)=>__oak_eq(__oak_cond,true)?__oak_trampoline(__oak_trampolined_sub,__as_oak_string(i+1)):-1)((i<max)))(_matchesAt__oak_qm(s,substr,i))}),__oak_resolve_trampoline(__oak_trampolined_sub,i)))()},sub(0)))()},contains__oak_qm=function contains__oak_qm(s=null,substr=null){return (indexOf(s,substr)>=0)},cut=function cut(s=null,sep=null){let idx;return ((__oak_cond)=>__oak_eq(__oak_cond,-1)?[s,__Oak_String(``)]:[slice(s,0,idx),slice(s,__as_oak_string(idx+len(sep)))])((idx=indexOf(s,sep)))},lower=function lower(s=null){return reduce(s,__Oak_String(``),function _(acc=null,c=null,i=null){return ((__oak_cond)=>__oak_eq(__oak_cond,true)?((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign((i),__oak_assgn_val):(__oak_assgn_tgt[__oak_obj_key((i))])=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(acc),char(__as_oak_string(codepoint(c)+32))):((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign((i),__oak_assgn_val):(__oak_assgn_tgt[__oak_obj_key((i))])=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(acc),c))(upper__oak_qm(c))})},upper=function upper(s=null){return reduce(s,__Oak_String(``),function _(acc=null,c=null,i=null){return ((__oak_cond)=>__oak_eq(__oak_cond,true)?((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign((i),__oak_assgn_val):(__oak_assgn_tgt[__oak_obj_key((i))])=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(acc),char((codepoint(c)-32))):((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign((i),__oak_assgn_val):(__oak_assgn_tgt[__oak_obj_key((i))])=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(acc),c))(lower__oak_qm(c))})},_replaceNonEmpty=function _replaceNonEmpty(s=null,old=null,__oak_js_new=null){return ((lnew,lold,sub)=>((lold=len(old)),(lnew=len(__oak_js_new)),sub=function sub(acc=null,i=null){return ((__oak_trampolined_sub)=>((__oak_trampolined_sub=function _(acc=null,i=null){return ((__oak_cond)=>__oak_eq(__oak_cond,true)?__oak_trampoline(__oak_trampolined_sub,__as_oak_string(__as_oak_string(slice(acc,0,i)+__oak_js_new)+slice(acc,__as_oak_string(i+lold))),__as_oak_string(i+lnew)):((__oak_cond)=>__oak_eq(__oak_cond,true)?__oak_trampoline(__oak_trampolined_sub,acc,__as_oak_string(i+1)):acc)((i<len(acc))))(_matchesAt__oak_qm(acc,old,i))}),__oak_resolve_trampoline(__oak_trampolined_sub,acc,i)))()},sub(s,0)))()},replace=function replace(s=null,old=null,__oak_js_new=null){return ((__oak_cond)=>__oak_eq(__oak_cond,__Oak_String(``))?s:_replaceNonEmpty(s,old,__oak_js_new))(old)},_splitNonEmpty=function _splitNonEmpty(s=null,sep=null){return ((coll,lsep,sub)=>((coll=[]),(lsep=len(sep)),sub=function sub(acc=null,i=null,last=null){return ((__oak_trampolined_sub)=>((__oak_trampolined_sub=function _(acc=null,i=null,last=null){return ((__oak_cond)=>__oak_eq(__oak_cond,true)?(__oak_push(coll,slice(acc,last,i)),__oak_trampoline(__oak_trampolined_sub,acc,__as_oak_string(i+lsep),__as_oak_string(i+lsep))):((__oak_cond)=>__oak_eq(__oak_cond,true)?__oak_trampoline(__oak_trampolined_sub,acc,__as_oak_string(i+1),last):__oak_push(coll,slice(acc,last)))((i<len(acc))))(_matchesAt__oak_qm(acc,sep,i))}),__oak_resolve_trampoline(__oak_trampolined_sub,acc,i,last)))()},sub(s,0,0)))()},split=function split(s=null,sep=null){return ((__oak_cond)=>__oak_eq(__oak_cond,null)?reduce(s,[],function _(acc=null,c=null){return __oak_push(acc,c)}):__oak_eq(__oak_cond,__Oak_String(``))?reduce(s,[],function _(acc=null,c=null){return __oak_push(acc,c)}):_splitNonEmpty(s,sep))(sep)},_extend=function _extend(pad=null,n=null){return ((part,sub,times)=>((times=int((n/len(pad)))),(part=(n%len(pad))),sub=function sub(base=null,i=null){return ((__oak_trampolined_sub)=>((__oak_trampolined_sub=function _(base=null,i=null){return ((__oak_cond)=>__oak_eq(__oak_cond,0)?__oak_push(base,slice(pad,0,part)):__oak_trampoline(__oak_trampolined_sub,__oak_push(base,pad),(i-1)))(i)}),__oak_resolve_trampoline(__oak_trampolined_sub,base,i)))()},sub(__Oak_String(``),times)))()},padStart=function padStart(s=null,n=null,pad=null){return ((__oak_cond)=>__oak_eq(__oak_cond,true)?s:__oak_push(_extend(pad,(n-len(s))),s))((len(s)>=n))},padEnd=function padEnd(s=null,n=null,pad=null){return ((__oak_cond)=>__oak_eq(__oak_cond,true)?s:__as_oak_string(s+_extend(pad,(n-len(s)))))((len(s)>=n))},_trimStartNonEmpty=function _trimStartNonEmpty(s=null,prefix=null){return ((idx,lpref,max,sub)=>((max=len(s)),(lpref=len(prefix)),sub=function sub(i=null){return ((__oak_trampolined_sub)=>((__oak_trampolined_sub=function _(i=null){return ((__oak_cond)=>__oak_eq(__oak_cond,true)?((__oak_cond)=>__oak_eq(__oak_cond,true)?__oak_trampoline(__oak_trampolined_sub,__as_oak_string(i+lpref)):i)(_matchesAt__oak_qm(s,prefix,i)):i)((i<max))}),__oak_resolve_trampoline(__oak_trampolined_sub,i)))()},(idx=sub(0)),slice(s,idx)))()},trimStart=function trimStart(s=null,prefix=null){return ((__oak_cond)=>__oak_eq(__oak_cond,__Oak_String(``))?s:_trimStartNonEmpty(s,prefix))(prefix)},_trimEndNonEmpty=function _trimEndNonEmpty(s=null,suffix=null){return ((idx,lsuf,sub)=>((lsuf=len(suffix)),sub=function sub(i=null){return ((__oak_trampolined_sub)=>((__oak_trampolined_sub=function _(i=null){return ((__oak_cond)=>__oak_eq(__oak_cond,true)?((__oak_cond)=>__oak_eq(__oak_cond,true)?__oak_trampoline(__oak_trampolined_sub,(i-lsuf)):i)(_matchesAt__oak_qm(s,suffix,(i-lsuf))):i)((i>-1))}),__oak_resolve_trampoline(__oak_trampolined_sub,i)))()},(idx=sub(len(s))),slice(s,0,idx)))()},trimEnd=function trimEnd(s=null,suffix=null){return ((__oak_cond)=>__oak_eq(__oak_cond,__Oak_String(``))?s:_trimEndNonEmpty(s,suffix))(suffix)},_trimSpace=function _trimSpace(s=null){return ((__oak_cond)=>__oak_eq(__oak_cond,__Oak_String(``))?s:((firstNonSpace,lastNonSpace,subEnd,subStart)=>(subStart=function subStart(i=null){return ((__oak_trampolined_subStart)=>((__oak_trampolined_subStart=function _(i=null){return ((__oak_cond)=>__oak_eq(__oak_cond,true)?__oak_trampoline(__oak_trampolined_subStart,__as_oak_string(i+1)):i)(space__oak_qm(__oak_acc(s,__oak_obj_key((i)))))}),__oak_resolve_trampoline(__oak_trampolined_subStart,i)))()},(firstNonSpace=subStart(0)),subEnd=function subEnd(i=null){return ((__oak_trampolined_subEnd)=>((__oak_trampolined_subEnd=function _(i=null){return ((__oak_cond)=>__oak_eq(__oak_cond,true)?__oak_trampoline(__oak_trampolined_subEnd,(i-1)):i)(space__oak_qm(__oak_acc(s,__oak_obj_key((i)))))}),__oak_resolve_trampoline(__oak_trampolined_subEnd,i)))()},(lastNonSpace=subEnd((len(s)-1))),slice(s,firstNonSpace,__as_oak_string(lastNonSpace+1))))())(s)},trim=function trim(s=null,part=null){return ((__oak_cond)=>__oak_eq(__oak_cond,null)?_trimSpace(s):trimStart(trimEnd(s,part),part))(part)},((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(_extend,__oak_assgn_val):(__oak_assgn_tgt._extend)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(__module),_extend),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(_matchesAt__oak_qm,__oak_assgn_val):(__oak_assgn_tgt._matchesAt__oak_qm)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(__module),_matchesAt__oak_qm),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(_replaceNonEmpty,__oak_assgn_val):(__oak_assgn_tgt._replaceNonEmpty)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(__module),_replaceNonEmpty),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(_splitNonEmpty,__oak_assgn_val):(__oak_assgn_tgt._splitNonEmpty)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(__module),_splitNonEmpty),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(_trimEndNonEmpty,__oak_assgn_val):(__oak_assgn_tgt._trimEndNonEmpty)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(__module),_trimEndNonEmpty),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(_trimSpace,__oak_assgn_val):(__oak_assgn_tgt._trimSpace)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(__module),_trimSpace),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(_trimStartNonEmpty,__oak_assgn_val):(__oak_assgn_tgt._trimStartNonEmpty)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(__module),_trimStartNonEmpty),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(checkRange,__oak_assgn_val):(__oak_assgn_tgt.checkRange)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(__module),checkRange),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(contains__oak_qm,__oak_assgn_val):(__oak_assgn_tgt.contains__oak_qm)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(__module),contains__oak_qm),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(cut,__oak_assgn_val):(__oak_assgn_tgt.cut)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(__module),cut),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(__oak_js_default,__oak_assgn_val):(__oak_assgn_tgt.__oak_js_default)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(__module),__oak_js_default),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(digit__oak_qm,__oak_assgn_val):(__oak_assgn_tgt.digit__oak_qm)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(__module),digit__oak_qm),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(endsWith__oak_qm,__oak_assgn_val):(__oak_assgn_tgt.endsWith__oak_qm)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(__module),endsWith__oak_qm),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(indexOf,__oak_assgn_val):(__oak_assgn_tgt.indexOf)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(__module),indexOf),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(join,__oak_assgn_val):(__oak_assgn_tgt.join)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(__module),join),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(letter__oak_qm,__oak_assgn_val):(__oak_assgn_tgt.letter__oak_qm)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(__module),letter__oak_qm),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(lower,__oak_assgn_val):(__oak_assgn_tgt.lower)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(__module),lower),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(lower__oak_qm,__oak_assgn_val):(__oak_assgn_tgt.lower__oak_qm)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(__module),lower__oak_qm),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(map,__oak_assgn_val):(__oak_assgn_tgt.map)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(__module),map),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(padEnd,__oak_assgn_val):(__oak_assgn_tgt.padEnd)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(__module),padEnd),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(padStart,__oak_assgn_val):(__oak_assgn_tgt.padStart)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(__module),padStart),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(reduce,__oak_assgn_val):(__oak_assgn_tgt.reduce)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(__module),reduce),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(replace,__oak_assgn_val):(__oak_assgn_tgt.replace)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(__module),replace),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(slice,__oak_assgn_val):(__oak_assgn_tgt.slice)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(__module),slice),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(space__oak_qm,__oak_assgn_val):(__oak_assgn_tgt.space__oak_qm)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(__module),space__oak_qm),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(split,__oak_assgn_val):(__oak_assgn_tgt.split)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(__module),split),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(startsWith__oak_qm,__oak_assgn_val):(__oak_assgn_tgt.startsWith__oak_qm)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(__module),startsWith__oak_qm),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(trim,__oak_assgn_val):(__oak_assgn_tgt.trim)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(__module),trim),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(trimEnd,__oak_assgn_val):(__oak_assgn_tgt.trimEnd)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(__module),trimEnd),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(trimStart,__oak_assgn_val):(__oak_assgn_tgt.trimStart)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(__module),trimStart),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(upper,__oak_assgn_val):(__oak_assgn_tgt.upper)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(__module),upper),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(upper__oak_qm,__oak_assgn_val):(__oak_assgn_tgt.upper__oak_qm)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(__module),upper__oak_qm),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(word__oak_qm,__oak_assgn_val):(__oak_assgn_tgt.word__oak_qm)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(__module),word__oak_qm),__module))()}),(__Oak_Import_Aliases=({})),__oak_module_import(__Oak_String(``)))